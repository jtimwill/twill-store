...
describe ProductsController do
  ...
  describe "GET search" do
    it "sets @term" do
      get :search, params: {search_term: "lamborghini", page_number: "5"}
    ...
    context "with valid results" do
      before do
        ...
        get :search, params: {search_term: "a", page_number: "1"}
      end
    ...
    context "when @results = []" do
      before do
        get :search, params: {search_term: "", page_number: "1"}
      end
